...
namespace Dispetcher2
{
    public partial class F_Reports : Form
    {
        ...
        private void bTNBirki_Click_1(object sender, EventArgs e)
        {
            ...
            Dictionary<string, List<string>> countTotalDic = new Dictionary<string, List<string>>();
            ...
            for (int i = 0; i < selectedRows.Count; i++)
            {
                if (mainDic.ContainsKey(selectedRows[i].Cells[3].Value.ToString()))
                {
                    ...
                    countTotalDic[selectedRows[i].Cells[3].Value.ToString()].Add(selectedRows[i].Cells[5].Value.ToString());
                ...
                else
                {
                    ...
                    countTotalDic[selectedRows[i].Cells[3].Value.ToString()] = new List<string>
                    {
                        selectedRows[i].Cells[5].Value.ToString()
                    };
            ...
            foreach (var order in mainDic.Keys)
            {
                ...
                sheet.Cells[startRow, startPos + 1].Value = nameOrderDic[order];
                sheet.Cells[startRow, startPos + 1].Font.Size = 11;
                sheet.Cells[startRow, startPos + 1].Font.Bold = 1;
                ...
                {
                    Console.WriteLine(x);
                    sheet.Cells[startRow + 2, startPos + sdvigVpravo].Value = n;
                    sheet.Cells[startRow + 2, startPos + sdvigVpravo].Font.Size = 11;
                    sheet.Cells[startRow + 2, startPos + sdvigVpravo].Font.Bold = 1;
                    sdvigVpravo += 1;
                }
                ...
                sheet.Cells[startRow + 5, startPos].Font.Size = 10;
                //sheet.Cells[startRow + 4, startPos].Font.Bold = 1;
                sheet.Cells[startRow + 5, startPos + 1].Value = selectedRows[startRowList].Cells[5].Value;
                sheet.Cells[startRow + 5, startPos + 1].Font.Size = 11;
                sheet.Cells[startRow + 5, startPos + 1].Font.Bold = 1;
                sheet.Cells[startRow + 5, startPos + 1].HorizontalAlignment = Excel.Constants.xlLeft;


                sheet.Cells[startRow + 6, startPos + 2].Value = "ПОЗ.";
                sheet.Cells[startRow + 6, startPos + 2].Font.Size = 10;
                sheet.Cells[startRow + 6, startPos + 2].HorizontalAlignment = Excel.Constants.xlRight;
                //sheet.Cells[startRow + 4, startPos].Font.Bold = 1;

                Console.WriteLine(posDic[order]);

                var sdvigVpravoPos = 0;
                foreach (var pos in posDic[order])
                {
                    sheet.Cells[startRow + 6, startPos + 3].Value = pos;
                    sheet.Cells[startRow + 6, startPos + 3].Font.Size = 11;
                    sheet.Cells[startRow + 6, startPos + 3].Font.Bold = 1;
                    sheet.Cells[startRow + 6, startPos + 3].HorizontalAlignment = Excel.Constants.xlLeft;
                    sheet.Cells[startRow + 6, startPos + 3].HorizontalAlignment = Excel.Constants.xlCenter;
                    sdvigVpravoPos += 1;
                }
