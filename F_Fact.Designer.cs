...
namespace Dispetcher2
{
    partial class F_Fact
    {
        ...
        private void InitializeComponent()
        {
			...
			// Col_Oper
			// 
			this.Col_Oper.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.None;
			this.Col_Oper.Frozen = true;
			this.Col_Oper.HeaderText = "Операция";
			this.Col_Oper.MinimumWidth = 20;
			this.Col_Oper.Name = "Col_Oper";
			this.Col_Oper.ReadOnly = true;
			this.Col_Oper.Width = 315;
			// 
			// Col_Tpd
			// 
			...
			this.Col_AmountDetails.DefaultCellStyle = dataGridViewCellStyle6;
			...
			this.oShCMContextMenuStrip.Size = new System.Drawing.Size(180, 22);
